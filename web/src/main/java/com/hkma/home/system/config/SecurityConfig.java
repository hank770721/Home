...
import com.hkma.home.system.repository.impl.SystemJdbcTokenRepositoryImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SystemPersistentTokenRepository persistentTokenRepository() {
		...
		//資料庫
		SystemJdbcTokenRepositoryImpl persistentTokenRepository = new SystemJdbcTokenRepositoryImpl();
