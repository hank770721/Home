...
public interface RecordRepository extends JpaRepository<RecordEntity,String>{
	...
	List<RecordEntity> findByUserIdMonthOrderByRecordDateDesc(String userId, String month);
	...
	@Query(value="SELECT * FROM bank_record "
			...
			+ ")"
			+ "ORDER BY recordDate DESC", nativeQuery=true)
	List<RecordEntity> findByUserIdMonthAccountUserIdAccountIdOrderByRecordDateDesc(String userId, String month, String accountUserId, String accountId);
